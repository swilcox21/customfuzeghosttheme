...
(function(root, factory){
	...
	$.fn.ghostHunter.defaults = {
		...
		onPageLoad			: false,
		onKeyUp				: false,
		result_template 	: "<a id='gh-{{ref}}' class='gh-search-item'  href='{{link}}'><div style='margin:10px;'><h4>{{title}}</h4><div style='max-height:24px; overflow:hidden;'>{{description}}</div><small>{{pubDate}}</small></div></a>",
